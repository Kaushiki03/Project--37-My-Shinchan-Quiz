class Question {
  ...
  display(){
  this.title.html("My Shinchan Quiz");
  this.title.position(350,0);

  this.question.html("What is the vegetable that Shinchan hates to eat?");
  this.question.position(100,30);
  this.option1.html("1: Beans");
  this.option1.position(150,60);
  this.option2.html("2:Garlic ");
  this.option2.position(150,100);
  this.option3.html("3: Carrot");
  this.option3.position(150,140);
  this.option4.html("4: Capsicum");
